...
def parse_args():
    ...
    parser.add_argument('--aitod_show', action='store_true', help='aitod_show results')
    parser.add_argument(
        '--aitod_show-dir', help='directory where painted images will be saved')
    parser.add_argument(
        '--aitod_show-score-thr',
        type=float,
        default=0.3,
...
def main():
    ...
    assert args.out or args.show or args.show_dir, \
        ('Please specify at least one operation (save or aitod_show the results) '
         'with the argument "--out", "--aitod_show" or "aitod_show-dir"')
