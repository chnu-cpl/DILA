...
python tools/analysis_tools/analyze_results.py \
      ...
      [--wait-time ${WAIT_TIME}] \
      [--topk ${TOPK}] \
      [--aitod_show-score-thr ${SHOW_SCORE_THR}] \
...
```shell
python tools/misc/browse_dataset.py ${CONFIG} [-h] [--skip-type ${SKIP_TYPE[SKIP_TYPE...]}] [--output-dir ${OUTPUT_DIR}] [--not-aitod_show] [--aitod_show-interval ${SHOW_INTERVAL}]
```
